...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | PhilThrive🥝")[0];
}
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by PhilThrive🥝 %c 你正在访问PhilThrive🥝's小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| PhilThrive🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('PhilThrive🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // (currentTimeHtml =
  //   hnum < 18 && hnum >= 9
  //     ? `<img class='boardsign' src='https://lskypro.acozycotage.net/Fomalhaut/badge/F小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://picbed.philthrive.top/img/home_bg.webp);
    --darkmode-bg:url(https://picbed.philthrive.top/img/home_bg.webp);
    --mobileday-bg: url(https://picbed.philthrive.top/img/home_bg.webp);
    --mobilenight-bg: url(https://picbed.philthrive.top/img/home_bg.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.philthrive.top/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/home_bg.webp)')"></a></div>
              </div>
            </details>
